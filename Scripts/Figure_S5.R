...
#Spring 2020
#Generates Figure S5 and tests normality of the resulting distribution
...
#read in netcdfs------------------
setwd('file path for swot-simulated rivers')
...
ggsave('sd_swot_rivers.png', plot, width = 10, height = 10)