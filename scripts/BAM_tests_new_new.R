...
batchbam = function(file,directory,errorflag, minxs, mintime){ 
  ...
  if (amhgFlag == 1){
    run_bam_Craig= bam_estimate(bamdata=bamdata, bampriors = priors, variant = 'manning_amhg', stanmodel = craig_model)
    switch <- 1
  }
  else {
    run_bam_Craig= bam_estimate(bamdata=bamdata, bampriors = priors, variant = 'manning', stanmodel = craig_model)
  }
...
for (phase in allpepsi2){
  setwd(phase)
  output_directory=paste('C://Users//cbrinkerhoff//Box Sync//Ongoing Projects//geomorph_class//outputs//new_new_hydrographs//')
...
#prior distributions
B <- read.csv('C://Users//cbrinkerhoff//Box Sync//Ongoing Projects//geomorph_class//priors//priorsB.csv')
N <- read.csv('C://Users//cbrinkerhoff//Box Sync//Ongoing Projects//geomorph_class//priors//priorsN.csv')
...
r <- read.csv('C://Users//cbrinkerhoff//Box Sync//Ongoing Projects//geomorph_class//priors//priorsR.csv')
